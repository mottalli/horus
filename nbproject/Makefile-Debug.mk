...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/${PLATFORM}/horus

dist/Debug/${PLATFORM}/horus: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/${PLATFORM}
	${LINK.cc} -o dist/Debug/${PLATFORM}/horus ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/segmentationresult.o: segmentationresult.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/segmentationresult.o segmentationresult.cpp
...
${OBJECTDIR}/irissegmentator.o: irissegmentator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/irissegmentator.o irissegmentator.cpp

${OBJECTDIR}/segmentator.o: segmentator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/segmentator.o segmentator.cpp
...
${OBJECTDIR}/pupilsegmentator.o: pupilsegmentator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/pupilsegmentator.o pupilsegmentator.cpp
